...
if themes is {"5KMacBadge"} then
	...
	else if themes is {"Flavours-Blue"} then
	set progress description to "View Download Theme"
	set progress description to "Download Acidanthera OcBinaryData"
	set source to path to me as string
	set source to POSIX path of source & "Contents/Resources/View%20Boot%200.7/Flavours-Blue.png"
	set source to quoted form of source
	do shell script "open " & source & "/"
	set source to path to me as string
	set x to display dialog "Do you like it and Download?" buttons {"I don't like it ➤ Quit", "I Like it ➤ Download"} default button 2
	...
	set targetFile to POSIX path of ThePath
	--since you are using curl
	set weblink to "https://github.com/chris1111/My-Simple-OC-Themes/raw/master/Resources-0.7.0/Flavours-Blue.zip"
	set curl_command to "curl -L " & weblink & " -o " & ThePath
	...
	else if themes is {"Flavours-Design"} then
	set progress description to "View Download Theme"
	set progress description to "Download Acidanthera OcBinaryData"
	set source to path to me as string
	set source to POSIX path of source & "Contents/Resources/View%20Boot%200.7/Flavours-Design.png"
	set source to quoted form of source
	do shell script "open " & source & "/"
	set source to path to me as string
	set x to display dialog "Do you like it and Download?" buttons {"I don't like it ➤ Quit", "I Like it ➤ Download"} default button 2
	...
	set targetFile to POSIX path of ThePath
	--since you are using curl
	set weblink to "https://github.com/chris1111/My-Simple-OC-Themes/raw/master/Resources-0.7.0/Flavours-Design.zip"
	set curl_command to "curl -L " & weblink & " -o " & ThePath
	...
	else if themes is {"Flavours-MacSystem"} then
	set progress description to "View Download Theme"
	set progress description to "Download Acidanthera OcBinaryData"
	set source to path to me as string
	set source to POSIX path of source & "Contents/Resources/View%20Boot%200.7/Flavours-MacSystem.png"
	set source to quoted form of source
	do shell script "open " & source & "/"
	set source to path to me as string
	set x to display dialog "Do you like it and Download?" buttons {"I don't like it ➤ Quit", "I Like it ➤ Download"} default button 2
	...
	set targetFile to POSIX path of ThePath
	--since you are using curl
	set weblink to "https://github.com/chris1111/My-Simple-OC-Themes/raw/master/Resources-0.7.0/Flavours-MacSystem.zip"
	set curl_command to "curl -L " & weblink & " -o " & ThePath
